...
public class FrentCrossArchetypeQueryOnT1 : CrossArchetypeQueryOnT1
{
...
public class FrentCrossArchetypeQueryOnT3 : CrossArchetypeQueryOnT3
{
    private World? _world;
    private Query? _query;
...
public class FrentCrossArchetypeQueryOnT5 : CrossArchetypeQueryOnT5
{
    private World? _world;
    private Query? _query;
