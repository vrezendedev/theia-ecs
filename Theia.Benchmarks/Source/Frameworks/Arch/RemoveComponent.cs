...
public class ArchRemoveComponentOnT2 : RemoveComponentOnT2
{
    ...
    {
        for (int i = 0; i < EntityCount; i++)
            _world!.Remove<Component1>(_entities![i]);
    }
}

public class ArchRemoveComponentOnT3 : RemoveComponentOnT3
{
    private World? _world;
    private List<Entity>? _entities;
...
public class ArchRemoveComponentOnT5 : RemoveComponentOnT5
{
    private World? _world;
    private List<Entity>? _entities;
