...
public class EntityDbRemoveComponentOnT2 : RemoveComponentOnT2
{
    ...
    {
        for (int i = 0; i < EntityCount; i++)
            _entityStore!.Remove<Component1>(_entities![i]);
    }
}

public class EntityDbRemoveComponentOnT3 : RemoveComponentOnT3
{
    private EntityDatabase? _entityStore;
    private List<Entity>? _entities;
...
public class EntityDbRemoveComponentOnT5 : RemoveComponentOnT5
{
    private EntityDatabase? _entityStore;
    private List<Entity>? _entities;
