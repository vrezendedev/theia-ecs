...
public class FrifloDestroyEntityT1 : DestroyEntityT1
{
    ...
    {
        for (int i = 0; i < EntityCount; i++)
            _entities![i].DeleteEntity();
    }
}

public class FrifloDestroyEntityT3 : DestroyEntityT3
{
    private EntityStore? _entityStore;
    private List<Entity>? _entities;
...
public class FrifloDestroyEntityT5 : DestroyEntityT5
{
    private EntityStore? _entityStore;
    private List<Entity>? _entities;
