...
public class FrifloRemoveTagRelationOnT1 : RemoveTagRelationOnT1
{
    ...
    public override void Run()
    {
        ...
        for (int i = 0; i < Relations; i++)
            owner.RemoveRelation<LinkRelation>(_entities![i]);
    }
}

public class FrifloRemoveEvaluatedRelationOnT1 : RemoveEvaluatedRelationOnT1
{
    ...
    public override void Run()
    {
        ...
        for (int i = 0; i < Relations; i++)
            owner.RemoveRelation<EvaluatedLinkRelation>(_entities![i]);
    }
}
