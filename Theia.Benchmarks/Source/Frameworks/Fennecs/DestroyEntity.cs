...
public class FennecsDestroyEntityT1 : DestroyEntityT1
{
...
public class FennecsDestroyEntityT3 : DestroyEntityT3
{
    private World? _world;
    private List<Entity>? _entities;
...
public class FennecsDestroyEntityT5 : DestroyEntityT5
{
    private World? _world;
    private List<Entity>? _entities;
