...
public class FennecsRemoveTagRelationOnT1 : RemoveTagRelationOnT1
{
    ...
    public override void Run()
    {
        ...
        for (int i = 0; i < Relations; i++)
            owner.Remove<TagRelation1>(_entities![i]);
    }
}

public class FennecsRemoveEvaluatedRelationOnT1 : RemoveEvaluatedRelationOnT1
{
    public Entity Owner { get; set; }
    private World? _world;
    private List<Entity>? _entities;
    ...
    public override void Run()
    {
        ...
        for (int i = 0; i < Relations; i++)
            owner.Remove<EvaluatedRelation1>(_entities![i]);
    }
}
